...
Defined in: [packages/functions/src/addcachetag/types.ts:8](https://github.com/pc-style/vercel/blob/main/packages/functions/src/addcachetag/types.ts#L8)
...
One or more tags to add to the cache content.
