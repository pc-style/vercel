...
# Function: dangerouslyDeleteBySrcImage()
...
Defined in: [packages/functions/src/purge/index.ts:28](https://github.com/pc-style/vercel/blob/main/packages/functions/src/purge/index.ts#L28)
